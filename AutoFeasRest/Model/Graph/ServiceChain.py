...
from AutoFeasRest.Model.Graph.Link import VirtualLink
from AutoFeasRest.Model.Graph.Requirement import SCRequirement
from AutoFeasRest.Model.Graph.VNF import VNF
